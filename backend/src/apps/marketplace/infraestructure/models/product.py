...
class ProductModel(models.Model):
    ...
    seller = models.ForeignKey(UserModel, related_name='items_selling', on_delete=models.CASCADE,null=True, blank=True) #quitar los null
    buyer = models.ForeignKey(UserModel, related_name='items_bought', on_delete=models.SET_NULL, null=True, blank=True)
